...
export class TimeSimulation {
  ...
  constructor() {
    if (TimeSimulation.instance) {
      // eslint-disable-next-line no-constructor-return
      return TimeSimulation.instance;
    }
    this.currentTime = 0;
    this.speed = 1;
    this.previousUpdateTime = 0;
    TimeSimulation.instance = this;
  }
  ...
  update(newTime) {
    // const timeDiff = newTime - this.previousUpdateTime;
    if (newTime === 15) {
      this.currentTime = 21;
    } else if (newTime === 17) {
      this.currentTime = 27;
    ...
    this.previousUpdateTime = newTime;
  }
}
