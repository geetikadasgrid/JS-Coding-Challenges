...
// ```
export function buyingCar(startPriceOld, startPriceNew, savingPerMonth, percentLossByMonth) {
  let months = 0;
  let savings = 0;
  ...
  return [months, Math.floor(oldCarPrice + savings - newCarPrice)];
}
